            ...
            <footer className="footer p-10 bg-base-200 text-base-content">
                ...
                <div className='mx-auto'>
                    ...
                    <div className='flex text-3xl'>
                        <FaCcVisa className='mt-2 mr-5 text-gray-500'></FaCcVisa>
                        <SiApplepay className='mt-2 mr-5'></SiApplepay>
                        <FaCcMastercard className='mt-2 mr-5 '></FaCcMastercard>
                        <FaCcPaypal className='mt-2 mr-5'></FaCcPaypal>
                        <FaGooglePay className='text-black text-5xl font-bold'></FaGooglePay>
                    </div>
                </div>
            </footer>
